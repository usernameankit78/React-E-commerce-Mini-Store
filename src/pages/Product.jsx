    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in-out duration-500 opacity-100">
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
          ...
          <button onClick={()=>addToCart(productData._id,size)} className='bg-black text-white px-8 py-3 text-sm cursor-pointer active:bg-gray-700'>
            ADD TO CART
          </button>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Mollitia, labore? Quaerat doloremque dolor, quos consectetur omnis blanditiis odit itaque voluptatum distinctio facere.</p>
          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Mollitia, labore? Quaerat doloremque dolor, quos consectetur omnis blanditiis odit itaque voluptatum distinctio facere.</p>
        </div>
      </div>
